...
**Stack principal:** **css + html**
**Contexto comum:** frontend desenvolvimento de interfaces web, estruturação de páginas com HTML5, estilização com CSS3, responsividade, layout moderno (Flexbox/Grid), boas práticas, organização de arquivos e compatibilidade entre navegadores.
Se o foco estiver fora dessa stack (ex: JavaScript, backend, banco de dados ou infraestrutura), a explicação deve ser adaptada para o contexto de estrutura (HTML) e apresentação (CSS).
